    ...
    <>
      <div className='container1'>
              ...
              <a tabIndex="0" aria-live="assertive" className="ButtonElement" href="/" target="_self">
                <fl-logo>
                  <picture>
                    ...
                    <div className='logo'>
                    <img src="\images\logo-image.jpg" alt="" className='logo-image'/>HiLancer</div>
                  </picture>
        ...
        <div className='herosection'>
          ...
          {/* <div>
              <svg id="Layer_1"  className='chatbot' data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 122.88 119.35" height={50} width={50}>
          ...
          <div className='image-container'>
            {/* <img src="\images\i6.jpg" alt="Freelancing opportunity" /> */}
            <Chatbot/>
          </div>
